...
?>
								<div class="form-check search-content">
									<a href="publisherwise.php?catid=<?php  echo $row1['author'];?>"><input class="form-check-input" type="checkbox" value="" id="productCheckBox01">
									<label class="form-check-label" for="productCheckBox01">
...
?>
						<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									<div class="dz-media">
										<a href="book_details.php?id=<?php echo $row1['book_id']; ?>" ><img src="images/<?php echo $row1['image']; ?>">		</a>				
									</div>
									...
									<div class="dz-content">
										<h5 class="title"><a href="book_details.php?id=<?php echo $row1['book_id']; ?>"><?php $val=$row1['book']; $name = substr($val, 0, 20); echo $name;?>...</a></h5>
										<ul class="dz-tags">
...
<a href="book_details.php?id=<?php echo $row1['book_id']; ?>" class="btn btn-secondary box-btn btnhover2"> View Details</a>										</div>
									</div>
								</div>
							</div>
<?php 
