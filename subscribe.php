...
<div class="page-wraper">
		...
		<section class="content-inner border-bottom">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					<h4 class="title">Magazines - Subscription:</h4>
				</div>
    ...
    // Import the file where we defined the connection to Database.     
		...
		$bok=mysqli_query($con,"SELECT * FROM magazines ");
		 $count= mysqli_num_rows($bok);
    ?> 
				<?php
							  $result1 = mysqli_query($con,"SELECT * FROM magazines  LIMIT $start_from, $per_page_record");
					...
					<div class="col-book style-1">
						...
						<a href="magazine_details.php?id=<?php echo $row1['mid']; ?>"><img src="images/<?php echo $row1['image']; ?>" alt="book"></a>									
							...
							<div class="dz-content">
								<h5 class="title"><a href="magazine_details.php?id=<?php echo $row1['mid']; ?>"><?php echo $row1['mname']; ?></a></h5>
								
								
								
								<div class="book-footer">
									
									<a href="magazine_details.php?id=<?php echo $row1['mid']; ?>" class="btn btn-secondary box-btn btnhover2">View Details</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row page mt-0">
					...
					<div class="col-md-6">
						<nav aria-label="Blog Pagination">
							...
							$pagLink = "";    
							if($page>=2){   
							echo "<li class='page-item'><a class='page-link prev' href='subscribe.php?page=".($page-1)."'>Prev</a></li>";   
							}  
							for ($i=1; $i<=$total_pages; $i++) {   
							if ($i == $page) {   
							$pagLink .= "<li class='page-item'><a class = 'page-link active' href='subscribe.php?page="  
                                                .$i."'>".$i." </a></li>";   
							}               
							else  {   
							$pagLink .= "<li class='page-item'><a class = 'page-link' href='subscribe.php?page=".$i."'>   
																	".$i." </a></li>";     
							}   
							};     
							echo $pagLink;   
							...
							if($page<$total_pages){   
								echo "<li class='page-item'><a class = 'page-link' href='subscribe.php?page=".($page+1)."'>  Next </a></li>";   
							}   
							?>
								</ul>
      ...
      <button class='btn btn-secondary' onClick="go2Page();">Go</button>   
			...
			<div class="container">
				<div class="section-head book-align" style="margin-bottom: 50px;">
					<h2 class="title mb-0">Top Institute's Course Subscription</h2>
					<div class="pagination-align style-1">
						<div class="swiper-button-prev"><i class="fa-solid fa-angle-left"></i></div>
						<div class="swiper-pagination-two"></div>
						<div class="swiper-button-next"><i class="fa-solid fa-angle-right"></i></div>
					</div>
					<a href="coursefull" class="btn btn-primary m-t15 btnhover2">View More</a>
				</div>
				<div class="swiper-container books-wrapper-3 swiper-four">
					<div class="swiper-wrapper">
					
	<?php
						$result3 = mysqli_query($con,"SELECT * FROM course where ccate='institute' order by uptime DESC LIMIT 5");
							  
							  //$result3 = mysqli_query($con,"SELECT * FROM rentalbooks");
						...
						<div class="swiper-slide">
							<div class="books-card style-3 wow fadeInUp" data-wow-delay="0.2s">
								<div class="dz-media">
									<a href="course_details.php?id=<?php echo $row3['id']; ?>"><img src="images/<?php echo $row3["image"]; ?>" alt="book"></a>									
								</div>
								<div class="dz-content">
									<h5 class="title"><a href="course_details.php?id=<?php echo $row3['id']; ?>"><?php echo $row3['ctitle']; ?></a></h5>
									<ul class="dz-tags">
										<li><del>₹<?php echo $row3['mrp']; ?></del></li>
										<li><span class="price-num" style="color:#1a1668;"><strong>₹ <?php echo $row3['csprice']; ?></strong></span></li>
	...
	<section class="content-inner-1">
			<div class="container">
				<div class="section-head book-align" style="margin-bottom: 50px;">
					<h2 class="title mb-0">Top Educator's Course Subscription</h2>
					<div class="pagination-align style-1">
						<div class="swiper-button-prev"><i class="fa-solid fa-angle-left"></i></div>
						<div class="swiper-pagination-two"></div>
						<div class="swiper-button-next"><i class="fa-solid fa-angle-right"></i></div>
					</div>
					<a href="course_edu" class="btn btn-primary m-t15 btnhover2">View More</a>
				</div>
				<div class="swiper-container books-wrapper-3 swiper-four">
					<div class="swiper-wrapper">
					
	<?php
						$result3 = mysqli_query($con,"SELECT * FROM course where ccate='educators' order by uptime DESC LIMIT 5");
   ...
   height:px;
    ...
    <div class="swiper-wrapper">
	<?php
$ret=mysqli_query($con,"SELECT * FROM books LIMIT 3");
$cnt=1;
	  $ct= mysqli_num_rows($ret);
while ($row1=mysqli_fetch_array($ret)) {

?>
      <div class="swiper-slide"><img src="images/background/bg1.jpg"></div>
      <?php
    ...
    <div class="swiper-pagination" id="banner"></div>
		...
		<section class="content-inner-1">
			<div class="container">
				...
				<a href="testefull" class="btn btn-primary m-t15 btnhover2">View More</a>
				</div>
					...
					<?php
						...
						<div class="swiper-slide">
							<div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.1s">
								<div class="dz-media">
									<a href="test_details.php?id=<?php echo $row1['id']; ?>"><img src="images/<?php echo $row1['image'] ?>" alt="book"></a></div>
								<div class="dz-info">
									<h4 class="dz-title"><a href="test_details.php?id=<?php echo $row1['id']; ?>"><?php echo $row1['title']; ?></a></h4>
