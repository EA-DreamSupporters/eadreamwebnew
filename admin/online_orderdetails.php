...
if(isset($_POST['takeaction']))
{
 ...
 $query="insert into ordertrackhistory(orderId,status,remark,actionBy,canceledBy) values('$oid','$status','$remark','$actionby',' $canceledBy');";
   ...
   $query.="update online_order set ordersts='$status' where oid='$oid'";
else:
...
$result = mysqli_multi_query($con, $query);
    ...
    echo "<script>window.location.href ='online_order.php'</script>";
  }
  else
    {
...
<?php
$query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.oid='$oid'";  
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Online Order Details</h4>
...
<?php 
$x=1;
$query ="SELECT a.*,b.*,c.* FROM online_order AS a, ordersdetails AS b, books AS c WHERE a.orderno=b.orderNumber AND b.productId=c.book_id AND a.oid='$oid'";  
$result = mysqli_query($con, $query); 						  
