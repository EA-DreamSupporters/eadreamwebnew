...
.media .adddealer {
    margin-top: 0!important;
      ...
      <div class="main-panel">
		...
		<div class="col-md-12 col-xl-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Online Book Order</h4>
 ...
 $date=date("Y-m-d");
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.ordersts ='' ORDER BY a.orddate DESC";  
						  ...
						  ?>							   
                               <tr>  
									...
									<td style="color:red;"><?php if($row["ordersts"]==NULL){ echo 'Not Processed Yet'; } ?></td>
									<td><a href="online_orderdetails.php?oid=<?php echo $row['oid']; ?>" class=""><img src='images/edit.png' class='edit'></a> </td>
 ...
 <?php 
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.ordersts='Packed' ORDER BY orddate DESC";  
						  $result = mysqli_query($con, $query); 						  
                          while($row = mysqli_fetch_array($result))  
                          {  
						  ?>							   
                               <tr>  
									...
									<td><?php echo $row["amount"]; ?></td>
									<td><?php echo $row["orddate"]; ?></td>
									<td><span class="badge badge-info"><?php echo $row["ordersts"]; ?></span></td>
									<td><a href="online_orderdetails.php?oid=<?php echo $row['oid']; ?>" class=""><img src='images/edit.png' class='edit'></a> </td>
 ...
 <?php 
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.ordersts='Cancelled' ORDER BY orddate DESC";  
						  $result = mysqli_query($con, $query); 						  
                          while($row = mysqli_fetch_array($result))  
                          {  
						  ?>							   
                               <tr>  
									...
									<td><?php echo $row["amount"]; ?></td>
									<td><?php echo $row["orddate"]; ?></td>
									<td><span class="badge badge-danger"><?php echo $row["ordersts"]; ?></span></td>
									<td><a href="online_orderdetails.php?oid=<?php echo $row['oid']; ?>" class=""><img src='images/edit.png' class='edit'></a> </td>
 ...
 <?php 
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.ordersts='In Transit' ORDER BY orddate DESC";  
						  $result = mysqli_query($con, $query); 						  
                          while($row = mysqli_fetch_array($result))  
                          {  
						  ?>							   
                               <tr>  
									...
									<td><?php echo $row["amount"]; ?></td>
									<td><?php echo $row["orddate"]; ?></td>
									<td><span class="badge badge-warning"><?php echo $row["ordersts"]; ?></span></td>
									<td><a href="online_orderdetails.php?oid=<?php echo $row['oid']; ?>" class=""><img src='images/edit.png' class='edit'></a> </td>
 ...
 <?php 
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.ordersts='Delivered' ORDER BY orddate DESC";  
						  $result = mysqli_query($con, $query); 						  
                          while($row = mysqli_fetch_array($result))  
                          {  
						  ?>							   
                               <tr>  
									...
									<td><?php echo $row["amount"]; ?></td>
									<td><?php echo $row["orddate"]; ?></td>
									<td><span class="badge badge-success"><?php echo $row["ordersts"]; ?></span></td>
									<td><a href="online_orderdetails.php?oid=<?php echo $row['oid']; ?>" class=""><img src='images/edit.png' class='edit'></a> </td>
 ...
 <?php 
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid ORDER BY orddate DESC";  
						  $result = mysqli_query($con, $query); 						  
                          while($row = mysqli_fetch_array($result))  
                          {  
						  ?>							   
                               <tr>  
									...
									<?php }elseif($row["ordersts"] == 'Packed'){ ?>
