...
$sql=mysqli_query($con, "INSERT INTO books(image, cat_id, subcat_id, book, price, totquantity, author, description,mrp) 
VALUES('$file_name','$category','$subcategory','$book','$price','$quantity','$author','$desc','$mrp')");
