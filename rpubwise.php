...
?>
								<div class="form-check search-content">
									<a href="rpubwise.php?catid=<?php  echo $row['rauthor'];?>"><input class="form-check-input" type="checkbox" value="" id="productCheckBox01">
									<label class="form-check-label" for="productCheckBox01">
...
$bok=mysqli_query($con,"SELECT * FROM rentalbooks where rauthor='$categoryid'");
		 $tot= mysqli_num_rows($bok);			
    ?>
						<?php
$categoryid=$_GET['catid'];
$query=mysqli_query($con,"select * from rentalbooks where rauthor='$categoryid' LIMIT $start_from, $per_page_record");
...
$cnt=$cnt+1;
					...
					<div class="col-md-6">
						<nav aria-label="Blog Pagination">
							...
							$pagLink = "";    
							if($page>=2){   
							echo "<li class='page-item'><a class='page-link prev' href='rpubwise.php?page=".($page-1)."'>Prev</a></li>";   
							}  
							for ($i=1; $i<=$total_pages; $i++) {   
							if ($i == $page) {   
							$pagLink .= "<li class='page-item'><a class = 'page-link active' href='rpubwise.php?page="  
                                                .$i."'>".$i." </a></li>";   
							}               
							else  {   
							$pagLink .= "<li class='page-item'><a class = 'page-link' href='rpubwise.php?page=".$i."'>   
																	".$i." </a></li>";     
							}   
							};     
							echo $pagLink;   
							...
							if($page<$total_pages){   
								echo "<li class='page-item'><a class = 'page-link' href='rpubwise.php?page=".($page+1)."'>  Next </a></li>";   
							}   
							?>
								</ul>
