  ...
  background-color: #FFFFCC;
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Previous Subscription</h4>
                ...
                <div class="col-12">
                  <div class="table-responsive">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
						  $query ="SELECT a.*,b.* FROM magazines AS a, subscriptions AS b WHERE a.mid=b.magazine AND b.user_id='$sid' AND (b.substatus='Rejected' OR b.edate < '$date') ORDER BY sdate DESC";  
