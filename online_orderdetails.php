...
$query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND a.orderno='$orderno'";  
...
<tr>
    ...
    <td><?php $ostatus=$row['ordersts'];
                    if( $ostatus==''): echo "Not Processed Yet";
                            ...
                            <br />
<a href="javascript:void(0);" onClick="popUpWindow('track_order.php?oid=<?php echo $row['oid'];?>');" title="Track order"> Track order
</a>
...
<?php
$ret=mysqli_query($con,"select*from online_order where ordersts!='Delivered'&& ordersts='' && orderno='$orderno'");
$nume=mysqli_num_rows($ret);
if($nume>0)
{
?>
<tr><td colspan="2"><a href="javascript:void(0);" onClick="popUpWindow('online_cancel.php?oid=<?php echo $row['oid'];?>');" title="Cancel Order" class="btn-upper btn btn-danger">Cancel this Order
</a></td></tr>
<?php 
}
?>
