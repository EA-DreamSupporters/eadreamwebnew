                  ...
                  <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
						  $query ="SELECT a.*,b.* FROM orders AS a, students AS b WHERE a.userId=b.sid AND b.sid='$sid' AND (a.orderStatus='Cancelled' OR a.orderStatus='Delivered') ORDER BY orderDate DESC";  
