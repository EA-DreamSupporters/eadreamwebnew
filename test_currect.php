                  ...
                  <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
  $query ="SELECT a.*,b.*,c.* FROM test AS a, students AS b, test_subscription AS c WHERE a.id=c.mid AND b.sid=c.uid AND c.mid=a.id AND c.status=0 AND b.sid='$sid'"; 						  $result = mysqli_query($con, $query); 						  
