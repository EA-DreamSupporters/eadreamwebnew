  ...
  background-color: #FFFFCC;
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Previous Rental Books</h4>
                  ...
                  <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
						  $query ="SELECT a.*,b.* FROM rentalbooks AS a, rentals AS b WHERE a.rid=b.rendalbook AND b.userid='$sid' AND(b.enddate < '$date' OR b.status='Rejected') ORDER BY rdate DESC";  
