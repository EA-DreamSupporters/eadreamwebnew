...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Test Pack - EA Dream Supporters</title>
...
<div class="page-wraper">
		...
		<section class="content-inner border-bottom">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					<h4 class="title"> Test - Subscription:</h4>
				</div>
    ...
    // Import the file where we defined the connection to Database.     
        ...
        $query = "SELECT * FROM test LIMIT $start_from, $per_page_record";     
        $rs_result = mysqli_query ($con, $query);    
		$bok=mysqli_query($con,"SELECT * FROM test ");
		 $count= mysqli_num_rows($bok);
    ?> 
				<?php
							  $result1 = mysqli_query($con,"SELECT * FROM test LIMIT $start_from, $per_page_record");
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							<div class="dz-media">
			<a href="test_details.php?id=<?php echo $row1['id']; ?>"><img src="images/<?php echo $row1['image']; ?>" alt="book"></a>									
							</div>
				...
				<h5 class="title"><a href="test_details.php?id=<?php echo $row1['id']; ?>"><?php $val=$row1['title']; $name = substr($val, 0, 14); echo $name;?>...</a></h5>
								
							
								<div class="book-footer">
									<div class="price">
										<span class="price-num">₹ <?php echo $row1['sprice']; ?></span>
										<del>₹ <?php echo $row1['mrp']; ?></del>
									</div>
									<a href="test_details.php?id=<?php echo $row1['id']; ?>" class="btn btn-secondary box-btn btnhover2"></i>View Details</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row page mt-0">
					...
					<div class="col-md-6">
						<nav aria-label="Blog Pagination">
							...
							$pagLink = "";    
							if($page>=2){   
							echo "<li class='page-item'><a class='page-link prev' href='testfull.php?page=".($page-1)."'>Prev</a></li>";   
							}  
							for ($i=1; $i<=$total_pages; $i++) {   
							if ($i == $page) {   
							$pagLink .= "<li class='page-item'><a class = 'page-link active' href='testfull.php?page="  
                                                .$i."'>".$i." </a></li>";   
							}               
							else  {   
							$pagLink .= "<li class='page-item'><a class = 'page-link' href='testfull.php?page=".$i."'>   
																	".$i." </a></li>";     
							}   
							};     
							echo $pagLink;   
							...
							if($page<$total_pages){   
								echo "<li class='page-item'><a class = 'page-link' href='testfull.php?page=".($page+1)."'>  Next </a></li>";   
							}   
							?>
								</ul>
		...
		<!-- Client End-->
			...
			<div class="container">
				<div class="section-head book-align" style="margin-bottom: 50px;">
					...
					<a href="coursefull.php" class="btn btn-primary m-t15 btnhover2">View More</a>
				</div>
	...
	<?php
						...
						<div class="swiper-slide">
							<div class="books-card style-3 wow fadeInUp" data-wow-delay="0.2s">
								...
								<div class="dz-content">
									<h5 class="title"><a href="course_details.php?id=<?php echo $row3['id']; ?>"><?php $val=$row3['ctitle']; $name = substr($val, 0, 20); echo $name;?>...</a></h5>
	...
	<section class="content-inner-1">
			<div class="container">
				<div class="section-head book-align" style="margin-bottom: 50px;">
					...
					<a href="course_edu.php" class="btn btn-primary m-t15 btnhover2">View More</a>
				</div>
				<div class="swiper-container books-wrapper-3 swiper-four">
					<div class="swiper-wrapper">
