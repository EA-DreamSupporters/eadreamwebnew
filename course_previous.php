                  ...
                  <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
  $query ="SELECT a.*,b.*,c.* FROM course AS a, students AS b, course_subscription AS c WHERE a.id=c.cid AND b.sid=c.uid AND c.cid=a.id AND(c.status='1' OR c.status='-1') AND b.sid='$sid'";
