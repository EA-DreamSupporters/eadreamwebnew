...
$query=mysqli_query($con,"select * from books where author='$categoryid'");
							...
							<div class="col-book style-2 line-content">
								<div class="dz-shop-card style-1">
									<div class="dz-media">
										...
										<img src="images/<?php echo $row['image']; ?>"></a>						
									</div>
								...
								<a href="book_details.php?id=<?php echo $row['book_id']; ?>" ><h5 class="title"><a href=""><?php  echo $row['book'];?></a></h5></a>
										<ul class="dz-tags">
