  ...
  background-color: #FFFFCC;
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Current Orders(Online Payment)</h4>
                  ...
                  <div class="table-responsive">  
                     <table id="employee_data" class="table table-striped table-bordered">  
						  ...
						  $sql1 = "SELECT * FROM students WHERE username='$user'";
							...
							$sid=$row1['sid'];
						  $x=1;
						  $query ="SELECT a.*,b.* FROM online_order AS a, students AS b WHERE a.uid=b.sid AND b.sid='$sid' AND (a.ordersts='' OR a.ordersts='Packed' OR a.ordersts='In Transit') ORDER BY orddate DESC";  
