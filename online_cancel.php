...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   online_order set ordersts='$ressta' where oid='$orderid'");
    if ($query) {
...
<?php  
$orderid=$_GET['oid'];
$query=mysqli_query($con,"select orderno,ordersts from online_order where oid='$orderid'");
...
<table border="1"  cellpadding="10" style="border-collapse: collapse; border-spacing:0; width: 100%; text-align: center;">
  <tr align="center">
   <th colspan="4" >Cancel Order #<?php echo  $row['orderno'];?></th> 
  </tr>
  <tr>
<th>Order Number </th>
